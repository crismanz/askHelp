class About extends React.Component{
  ...
  render() {
    return (
      ...
      <p>Once signed in, all users see a map with markers on it indicating people in need of community help.</p>
      <p>The markers are colored differently for two different kinds of needs: <br/>
      <img src="https://img.icons8.com/office/40/000000/marker.png"></img>one-time tasks (i.e., to help carry a piece of heavy furniture) or for a <br/>
      <img src="https://img.icons8.com/ultraviolet/40/000000/marker.png"></img>material need (i.e., a homeless woman on your street who needs a blanket for winter).
      </p>
